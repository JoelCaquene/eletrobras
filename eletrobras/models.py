...
# Modelo para Configurações Gerais da eletrobras
class Config(models.Model):
    ...
    class Meta:
        verbose_name = "Configuração da eletrobras"
        verbose_name_plural = "Configurações da eletrobras"

    def __str__(self):
        return "Configurações da eletrobras ELETROBRAS"
...
# Modelo para Detalhes Bancários da eletrobras
class PlatformBankDetails(models.Model):
    ...
    class Meta:
        verbose_name = "Detalhe Bancário da eletrobras"
        verbose_name_plural = "Detalhes Bancários da eletrobras"
...
class Deposito(models.Model):
    ...
    banco_destino_nome = models.CharField(max_length=100, verbose_name="Nome do Banco de Destino")
    nome_cliente_banco = models.CharField(max_length=100, verbose_name="Nome do Cliente no Banco")
